...
ENV_VAR_NAME = "CLI_CONFIG"
CLI_CONF_FILE = 'cli.cfg'
CWD_PATH = os.path.join(os.getcwd(), CLI_CONF_FILE)
USER_PATH = os.path.expanduser('~/.' + CLI_CONF_FILE)
SYSTEM_PATH = os.path.join('/etc/infrared', CLI_CONF_FILE)
YAML_EXT = ".yml"
TMP_OUTPUT_FILE = 'cli_settings_' + str(time.time()) + YAML_EXT
INFRARED_DIR_ENV_VAR = 'INFRARED_SETTINGS'
...
def load_config_file():
    ...
    if env_path is not None:
        ...
        if os.path.isdir(env_path):
            env_path = os.path.join(env_path, CLI_CONF_FILE)
